...
namespace QL_HSGVTHPT
{
    public partial class frmDangNhap : Form
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            if(obj.KiemTra_MK(_TenDN,_MatKhauDN,_ChucVu)==true||_TenDN=="admin"&&_MatKhauDN=="admin"&&_ChucVu=="Admin")
            {
        ...
        private void TxtMKDN_KeyDown(object sender, KeyEventArgs e)
        {
