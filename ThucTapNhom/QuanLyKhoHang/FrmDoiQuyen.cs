...
{
    public partial class FrmDoiQuyen : Form
    {
        ...
        private void btn_dq_Click_1(object sender, EventArgs e)
        {
        ...
        private void tbx_quyencu_TextChanged(object sender, EventArgs e)
        {

        }

        private void tbx_quyenmoi_TextChanged(object sender, EventArgs e)
        {
