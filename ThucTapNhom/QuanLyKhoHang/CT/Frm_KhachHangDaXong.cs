...
{
    public partial class Frm_KhachHangDaXong : UserControl
    {
        public Frm_KhachHangDaXong()
        {
            InitializeComponent();
        }
        ...
        private void txt_tenkh(object sender, KeyPressEventArgs e)
        {
        ...
        private void txt_dienthoai_leave(object sender, EventArgs e)
        {
        ...
        private void txt_dienthoai(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
