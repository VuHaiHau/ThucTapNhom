...
{
    public partial class Frm_DangNhap : DevComponents.DotNetBar.Office2007RibbonForm
    {
        public Frm_DangNhap()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read() == true)
            {
                ...
                Frm_DoiMatKhau.USERNAME = txtTaiKhoan.Text;
                Frm_DoiQuyen.USERNAME = txtTaiKhoan.Text;
                Frm_DoiMatKhau.QUYENHAN = QuyenHan;
                Frm_TaiKhoan.Username = txtTaiKhoan.Text;
