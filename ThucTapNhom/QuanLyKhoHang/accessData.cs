...
namespace QuanLyKhoHang
{
    class accessData
    {
        ...
        public SqlCommand THEMCTPN(string mapn, string masp, int soluong,float dongian)
        {
            OpenConnect();
            ...
            cmd.Parameters.Add(new SqlParameter("DONGIAN", dongian));
            
            cmd.ExecuteNonQuery();
            CloseConnect();
            return cmd;
        }
        public SqlCommand SUACTPN(string mapn, string masp, int soluong, float dongianhap)
        {
            OpenConnect();
            ...
            cmd.Parameters.Add(new SqlParameter("MASP", masp));
            cmd.Parameters.Add(new SqlParameter("SOLUONG", soluong));
            cmd.Parameters.Add(new SqlParameter("DONGIAN", dongianhap));
            cmd.ExecuteNonQuery();
            CloseConnect();
            return cmd;
        }
        ...
        public SqlCommand XOACHITIETPHIEUNHAP(string mapx)
        {
            OpenConnect();
            cmd = new SqlCommand("XOA_CHITIETPHIEUNHAP", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("MAPN", mapx));
            cmd.ExecuteNonQuery();
            CloseConnect();
            return cmd;
        }
        // them,sua chi tiet phieu xuat:
        public SqlCommand THEMCTPX(string mapx, string masp, int soluong, float dongiax)
        {
            OpenConnect();
            ...
            cmd.Parameters.Add(new SqlParameter("MASP", masp));
            cmd.Parameters.Add(new SqlParameter("SOLUONG", soluong));
            cmd.Parameters.Add(new SqlParameter("DONGIAX", dongiax));
            cmd.ExecuteNonQuery();
            CloseConnect();
            return cmd;
        }
        public SqlCommand SUACTPX(string mapx, string masp, int soluong, float dongiax)
        {
            OpenConnect();
        ...
        public SqlCommand THEMCTPN(string mapn, string masp, int soluong)
        {
            OpenConnect();
            cmd = new SqlCommand("THEM_CHITIETPHIEUNHAP", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlCommand SUACTPN(string mapn, string masp, int soluong)
        {
            OpenConnect();
            cmd = new SqlCommand("SUA_CHITIETPHIEUNHAP", con);
            cmd.CommandType = CommandType.StoredProcedure;
