...
namespace QuanLyKhoHang
{
    public partial class Frm_BaoCao : Form
    {
        ...
        private void btn_xemtatcax_Click_1(object sender, EventArgs e)
        {
            ...
            Frm_BaoCaoX_F.TenKho = cbx_khox.Text;
            Frm_BaoCaoX_F.TenNcc_Kh = cbx_khachhangx.Text;
            Frm_BaoCaoX_F.TenNv = cbx_nvx.Text;
            Frm_BaoCaoX_F.TenSp = cbx_spx.Text;
            Frm_BaoCaoX_F.TuNgay = tbx_tungayx.Text;
            Frm_BaoCaoX_F.NgayNh_Xu = tbx_ngayxuatx.Text;
            Frm_BaoCaoX_F.DenNgay = tbx_denngayx.Text;
            Frm_BaoCaoX_F.Gia = cbx_giax.Text;
            btn_xembaocaox.Enabled = true;
        }
        ...
        private void btn_xembaocaox_Click_1(object sender, EventArgs e)
        {
            ...
            Frm_BaoCaoX_F m=new Frm_BaoCaoX_F();
            m.ShowDialog();
        }
